  ...
  return (
    <LayoutContext.Provider value={{ isMobile, siderCollapsed: collapsed, setSiderCollapsed: setCollapsed }}>
      <NavigationHistoryProvider>
        <div className='app-shell novamaster-shell flex flex-col size-full min-h-0'>
          ...
          <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
            ...
            >
              ...
              >
                <div
                  className={classNames('novamaster-brandmark shrink-0 size-40px relative rd-0.5rem overflow-hidden', {
                    '!size-24px': collapsed,
                  })}
                  onClick={onClick}
                >
                  <img
                    src='/novamaster-icon.svg'
                    alt=''
                    draggable={false}
                ...
                <div className='novamaster-sidebar-title flex-1 text-20px text-1 collapsed-hidden font-bold'>
                  NovaMaster
                </div>
                {isMobile && !collapsed && (
                  <button
